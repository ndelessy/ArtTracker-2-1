...
public class GalleryPresenter{
    ...
    public GalleryPresenter(final Context context) {
    ...
    public void setGalleryFragment(GalleryFragment galleryFragment) {
        ...
        galleryFragment.setGalleryPresenter(this);
        Log.d(TAG, "GalleryPresenter got reference to gallery:"+galleryFragment);
    }
    ...
    public void deleteArtPiece(final ArtPieceWithArtist artPiece){
        new AsyncTask<Void, Void, Void>() {
            ...
            @Override
            protected void onPostExecute(Void voids) {
                galleryFragment.showArtPieceDeleted(artPiece);
            }
        }.execute();
    }
    ...
    public void start() {
        new AsyncTask<Void, Void, List<ArtPieceWithArtist>>() {
            ...
            protected void onPostExecute(List<ArtPieceWithArtist> artPieces) {
                Log.d(TAG, "Got all artPieces");
                galleryFragment.showArtPieces(artPieces);
            }
        }.execute();
            ...
            protected void onPostExecute(final List<ArtPiece> artPiecesByArtist) {
                ...
                new AsyncTask<Void, Void, Artist>() {
                    ...
                    protected void onPostExecute(Artist artist) {
                        galleryFragment.showArtist(artist, artPiecesByArtist);
                    }
                }.execute();
            }
        }.execute();
